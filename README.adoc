...
== About
This project started as an better way setup SCDF in a Cloud Foundry environment to support Spring Cloud Data Flow internal acceptance testing.
...
akin to Spring Boot, or at least Spring Framework Environment. So it can be done, but I imagine you would have to disable some of boot's auto-config that might
